""" Chain Of Thought Prompting for weather agent example using OpenAI's GPT-4o model. 
The agent can use two tools get_weather and run_command to resolve user queries. 
The agent works in a sequence of steps START, PLAN, TOOL and finally OUTPUT. 
The agent can call multiple PLAN steps but only one TOOL step before giving the final OUTPUT."""
